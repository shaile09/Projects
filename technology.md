...
We will be using Pandas to clean the data and perform exploratory analysis. Further analysis will be conducted using Python. We will be importing the yelp data with an API key, and converting that dataset, which is in JSON format, into a dataframe.

## Database Storage
Postgres is the database we will be using.

## Machine Learning
Linear Regression, Deep Learning, and Random Forest Classifier are the machine learning models we will be using to train and test our data.
